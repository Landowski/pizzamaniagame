document.addEventListener('DOMContentLoaded', function () {
  ...
  const audio = new Audio('/sound/cash-register.mp3');
  ...
  function applyTranslation() {
    ...
    textPizzasMade.innerHTML = `<img src="images/counter-pizzas.svg" width="24" height="24">${texts.textPizzasMade}`;
    ...
    textYourMoney.innerHTML = `<img src="images/button-cash-register.svg" width="24" height="24">${texts.textYourMoney}`;
